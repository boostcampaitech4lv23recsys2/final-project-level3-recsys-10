    ...
    "
        ...
        <div className="relative flex items-center">
          ...
          <div className="relative dropdown">
            <a
              className="flex items-center mr-4 text-gray-500 hover:text-gray-700 focus:text-gray-700 dropdown-toggle hidden-arrow"
              href="#"
            ...
            <ul
              className="absolute right-0 left-auto z-50 hidden float-left py-2 m-0 mt-1 text-base text-left list-none bg-white border-none rounded-lg shadow-lg dropdown-menu min-w-max bg-clip-padding"
