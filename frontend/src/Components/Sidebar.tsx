...
const Sidebar: FC<myType> = ({ setIsSidebarOpen, itemList, markerList }) => {
  ...
  return (
    <aside className="fixed top-0 right-0 z-40 h-screen min-h-screen duration-700 ease-in-out transition-transform-translate-x-full sm:translate-x-5 md:flex">
